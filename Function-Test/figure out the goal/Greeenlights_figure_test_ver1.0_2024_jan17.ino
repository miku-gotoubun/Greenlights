...
//ゴールの設定
double golelat = 33.6203016;
double golelot = 133.7192874;  //Latitude: 33.6204767, Longitude: 133.7194283
...
void loop() {
  while (gpsSerial.available() > 0) {
    if (gps.encode(gpsSerial.read())) {
      ...
      */
      ...
      if(Mag_Degree>30 && Mag_Degree<180) {
        //左回転
      digitalWrite(INB1,HIGH);
      digitalWrite(INB2,LOW);
      ledcWrite(1,160);
      ...
      ledcWrite(0,0);
      delay(Mag_Degree*0.8);
      Serial.println("BMX左回転");
      //停止
      digitalWrite(INA1, LOW);
      digitalWrite(INA2, LOW);
      ledcWrite(0, 0);
  ...
  else if(Mag_Degree<-30 && Mag_Degree>-180) {
      //右回転
      digitalWrite(INA1, LOW);
      digitalWrite(INA2, HIGH);
      ledcWrite(0, 160);
  ...
  else if(Mag_Degree>=-30 && Mag_Degree=<30) {
    //停止
      digitalWrite(INA1, LOW);
      digitalWrite(INA2, LOW);
      ledcWrite(0, 0);
